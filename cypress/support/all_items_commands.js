...
//Standard User ------------------------------------------------------------------------------------------------------------------
Cypress.Commands.add('sauce_labs_bp_all', () => {
...
Cypress.Commands.add('sauce_labs_blight_all', () => {
...
Cypress.Commands.add('sauce_labs_bshirt_all', () => {
...
Cypress.Commands.add('sauce_labs_fjacket_all', () => {
    cy.get('[data-test=add-to-cart-sauce-labs-fleece-jacket]').click()
    cy.get('.shopping_cart_link').should('be.visible')
    cy.get('.shopping_cart_badge').should('be.visible').and('contain', '4')
    cy.get('.shopping_cart_link').click()
    cy.get('.shopping_cart_link').should('be.visible')
    cy.get('.shopping_cart_badge').should('be.visible').and('contain', '4')
    cy.get('.title').should('be.visible').and('contain', 'Your Cart')
...
Cypress.Commands.add('sauce_labs_onesie_all', () => {
...
Cypress.Commands.add('sauce_labs_allthings_all', () => {
    cy.get('[data-test="add-to-cart-test.allthethings()-t-shirt-(red)"]').click()
    cy.get('.shopping_cart_link').should('be.visible')
    cy.get('.shopping_cart_badge').should('be.visible').and('contain', '6')
    cy.get('.shopping_cart_link').click()
    cy.get('.shopping_cart_link').should('be.visible')
    cy.get('.shopping_cart_badge').should('be.visible').and('contain', '6')
    cy.get('.title').should('be.visible').and('contain', 'Your Cart')
